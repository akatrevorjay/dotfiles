...
function __promptline {
  ...
  local a_fg="${wrap}38;5;150${end_wrap}"
  local a_bg="${wrap}48;5;232${end_wrap}"
  local a_sep_fg="${wrap}38;5;232${end_wrap}"
  local b_fg="${wrap}38;5;232${end_wrap}"
  local b_bg="${wrap}48;5;150${end_wrap}"
  local b_sep_fg="${wrap}38;5;150${end_wrap}"
  ...
  local x_fg="${wrap}38;5;150${end_wrap}"
  local x_bg="${wrap}48;5;232${end_wrap}"
  local x_sep_fg="${wrap}38;5;232${end_wrap}"
  local y_fg="${wrap}38;5;232${end_wrap}"
  local y_bg="${wrap}48;5;150${end_wrap}"
  local y_sep_fg="${wrap}38;5;150${end_wrap}"
  local z_fg="${wrap}38;5;150${end_wrap}"
  local z_bg="${wrap}48;5;232${end_wrap}"
  local z_sep_fg="${wrap}38;5;232${end_wrap}"
  if [[ -n ${ZSH_VERSION-} ]]; then
