...
function __promptline {
  ...
  local a_bg="${wrap}48;5;56${end_wrap}"
  local a_sep_fg="${wrap}38;5;56${end_wrap}"
  local b_fg="${wrap}38;5;206${end_wrap}"
  ...
  local x_fg="${wrap}38;5;254${end_wrap}"
  local x_bg="${wrap}48;5;238${end_wrap}"
  local x_sep_fg="${wrap}38;5;238${end_wrap}"
  local y_fg="${wrap}38;5;206${end_wrap}"
  local y_bg="${wrap}48;5;234${end_wrap}"
  local y_sep_fg="${wrap}38;5;234${end_wrap}"
  local z_fg="${wrap}38;5;254${end_wrap}"
  local z_bg="${wrap}48;5;56${end_wrap}"
  local z_sep_fg="${wrap}38;5;56${end_wrap}"
  if [[ -n ${ZSH_VERSION-} ]]; then
