...
function __promptline {
  ...
  local a_bg="${wrap}48;5;143${end_wrap}"
  local a_sep_fg="${wrap}38;5;143${end_wrap}"
  local b_fg="${wrap}38;5;253${end_wrap}"
  local b_bg="${wrap}48;5;236${end_wrap}"
  local b_sep_fg="${wrap}38;5;236${end_wrap}"
  local c_fg="${wrap}38;5;216${end_wrap}"
  ...
  local x_fg="${wrap}38;5;216${end_wrap}"
  ...
  local z_fg="${wrap}38;5;234${end_wrap}"
  local z_bg="${wrap}48;5;143${end_wrap}"
  local z_sep_fg="${wrap}38;5;143${end_wrap}"
  if [[ -n ${ZSH_VERSION-} ]]; then
