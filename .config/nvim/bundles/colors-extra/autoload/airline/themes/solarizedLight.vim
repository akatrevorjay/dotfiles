...
function! airline#themes#solarizedLight#refresh()
  """"""""""""""""""""""""""""""""""""""""""""""""
  " Options
  """"""""""""""""""""""""""""""""""""""""""""""""
  let s:background  = get(g:, 'airline_solarizedLight_bg', &background)
  let s:ansi_colors = get(g:, 'solarizedLight_termcolors', 16) != 256 && &t_Co >= 16 ? 1 : 0
  let s:tty         = &t_Co == 8
  ...
  let g:airline#themes#solarizedLight#palette.inactive = airline#themes#generate_color_map(
  ...
  let g:airline#themes#solarizedLight#palette.normal = airline#themes#generate_color_map(
        \ [s:N1[0].g, s:N1[1].g, s:N1[0].t, s:N1[1].t, s:N1[2]],
        \ [s:N2[0].g, s:N2[1].g, s:N2[0].t, s:N2[1].t, s:N2[2]],
        \ [s:N3[0].g, s:N3[1].g, s:N3[0].t, s:N3[1].t, s:N3[2]])

  let g:airline#themes#solarizedLight#palette.normal.airline_warning = [
  ...
  let g:airline#themes#solarizedLight#palette.normal_modified.airline_warning =
        \ g:airline#themes#solarizedLight#palette.normal.airline_warning

  let g:airline#themes#solarizedLight#palette.insert = airline#themes#generate_color_map(
        \ [s:I1[0].g, s:I1[1].g, s:I1[0].t, s:I1[1].t, s:I1[2]],
        \ [s:I2[0].g, s:I2[1].g, s:I2[0].t, s:I2[1].t, s:I2[2]],
        \ [s:I3[0].g, s:I3[1].g, s:I3[0].t, s:I3[1].t, s:I3[2]])

  let g:airline#themes#solarizedLight#palette.insert.airline_warning =
        \ g:airline#themes#solarizedLight#palette.normal.airline_warning
  ...
  let g:airline#themes#solarizedLight#palette.insert_modified.airline_warning =
        \ g:airline#themes#solarizedLight#palette.normal.airline_warning

  let g:airline#themes#solarizedLight#palette.visual = airline#themes#generate_color_map(
  ...
  let g:airline#themes#solarizedLight#palette.visual.airline_warning =
        \ g:airline#themes#solarizedLight#palette.normal.airline_warning
  ...
  let g:airline#themes#solarizedLight#palette.visual_modified.airline_warning =
        \ g:airline#themes#solarizedLight#palette.normal.airline_warning

  let g:airline#themes#solarizedLight#palette.replace = airline#themes#generate_color_map(
  ...
  let g:airline#themes#solarizedLight#palette.replace.airline_warning =
        \ g:airline#themes#solarizedLight#palette.normal.airline_warning

  let g:airline#themes#solarizedLight#palette.replace_modified = {
        \ 'airline_c': [s:RM[0].g, s:RM[1].g,
        \ s:RM[0].t, s:RM[1].t, s:RM[2]]}

  let g:airline#themes#solarizedLight#palette.replace_modified.airline_warning =
        \ g:airline#themes#solarizedLight#palette.normal.airline_warning

  let g:airline#themes#solarizedLight#palette.tabline = {}

  let g:airline#themes#solarizedLight#palette.tabline.airline_tab = [
        \ s:I2[0].g, s:I2[1].g, s:I2[0].t, s:I2[1].t, s:I2[2]]

  let g:airline#themes#solarizedLight#palette.tabline.airline_tabtype = [
        \ s:N2[0].g, s:N2[1].g, s:N2[0].t, s:N2[1].t, s:N2[2]]
endfunction

call airline#themes#solarizedLight#refresh()
