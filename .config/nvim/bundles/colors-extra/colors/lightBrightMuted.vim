" Vim color file
" Converted from Textmate theme jordowTMTheme using Coloration v0.3.2 (http://github.com/sickill/coloration)
...
let g:colors_name = "lightBrightMuted"

" Ocaml merlin
hi EnclosingExpr ctermbg=17 guibg=#2d362a

" Dead, no longer using PowerLine.
" let g:Powerline_colorscheme='lightBrightMuted'
" let g:Powerline_theme = 'customDefault'

hi SignColumn ctermfg=231 ctermbg=232 cterm=NONE guifg=#d0d0c0 guibg=#262624 gui=NONE
...
hi Normal ctermfg=231 ctermbg=232 cterm=NONE guifg=#d0d0c0 guibg=#262624 gui=NONE
hi javaScriptFunction ctermfg=192 ctermbg=NONE cterm=NONE guifg=#d6f38d guibg=NONE gui=NONE
hi Comment ctermfg=101 ctermbg=232 cterm=NONE guifg=#656557 guibg=#262624 gui=italic
...
hi DiffChange guibg=#24262b ctermbg=234
...
hi CursorLine guibg=#2a2a28 ctermbg=234 gui=none cterm=none
hi CursorColumn guibg=#2d2d2d ctermbg=235
hi Search guifg=#262624 ctermfg=233 guibg=#ffffaa ctermbg=229
...
hi LineNr guifg=#3f3f3d ctermfg=235 guibg=#282826 ctermbg=16 gui=none cterm=none
...
hi VertSplit guifg=#282826 ctermfg=16 guibg=#282826 ctermbg=16 gui=none cterm=none
...
hi TabLine guifg=#999999 ctermfg=246 guibg=#282826 ctermbg=16 gui=bold cterm=bold
hi TabLineFill guifg=#282826 ctermfg=16 ctermfg=231
hi TabLineSel gui=bold cterm=bold
hi Pmenu guifg=#8a9bb0 ctermfg=174 guibg=#2c2c2b ctermbg=234
hi PmenuSel guifg=#2c2c2b ctermfg=234 guibg=#8a9bb0 ctermbg=174 gui=bold cterm=bold
hi PmenuSbar guifg=#2c2c2b ctermfg=234 guibg=#2c2c2b ctermbg=234 gui=bold cterm=bold
hi PmenuThumb guifg=#585856 ctermfg=246 guibg=#585856 ctermbg=246 gui=bold cterm=bold
hi NonText guifg=#282826 ctermfg=16 guibg=#282826 ctermbg=16 gui=none cterm=none

hi! link VisualNOS	Visual
hi! link FoldColumn	Folded

" For now, use the lightBright airline theme - no custom one for lightBrightMuted
" let g:airline_theme='lightBright'
